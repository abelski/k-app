...
var RegistrationService = (function () {
    ...
    RegistrationService.prototype.tryLogin = function () {
        ...
        if (tokenSaved) {
            ...
            Globals.userInfo = this.restoreUserFromCookies();
    ...
    RegistrationService.prototype.fetchUserInfo = function () {
        ...
        if (this.token != null) {
            ...
            this.http.get(this.oAuthUserUrl, { headers: headers })
                ...
                var user = new user_1.User(info.name.givenName, info.name.familyName, info.gender, null, info.placesLived ? info.placesLived[0].value : null, "", "", new image_1.Image(info.id, "Profile Avatar", "jpg", info.image.url, "Profile Avatar"));
    ...
    RegistrationService.prototype.getUserName = function () {
        return Globals.userInfo ? Globals.userInfo[this.oAuthUserNameField] : null;
    };
