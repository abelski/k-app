...
var VacationService = (function () {
    ...
    VacationService.prototype.getVacation = function (id) {
        return this.http.get(url_util_1.UrlUtil.GET_VACATION + id)
            .map(this.extractData)
            .catch(this.handleError);
    };
    VacationService.prototype.addMember = function (id, member) {
        var body = JSON.stringify(member);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
        return this.http.post(url_util_1.UrlUtil.ADD_MEMBER + id, body, options)
            .map(this.extractData)
            .catch(this.handleError);
        ;
    };
    VacationService.prototype.createVacation = function (vacation) {
